...
document.getElementById('izvedi').addEventListener('click', () => {
  ...
  switch (zadatak) {
    case '1':
      ...
      // moj dokaz je taj da kada nađem prvi broj koji je cjelobrojno djeljiv (ostatak 0) prekidam izvođenje i mijenjam prim na false


      for(let i=2; i<broj; i++){
        if(i % 10000 === 0){
          console.log('Obrađujem', i, '/', broj, parseInt((i/broj)*100))
        }

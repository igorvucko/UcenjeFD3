...
// 2 koraka rada s funkcija: definicija i pozivanje

// redoljed definicije i pozivanja nije bitan
odradi()
...
function log(poruka){
    ...
    console.log('\n') // backslash = Alt Gr + Q  - prelazi u novi red
    console.log('+-------------------------+')
    console.log(poruka)
    console.log('+-------------------------+') 
}
 ...
 */
function slucajniBroj(odBroja=0, doBroja=0){ // () znači da ne prima parametre, = daje zadanu vrijednost, to su opcionalni parametri
    if(odBroja && doBroja){
...
// varijabli sb dodjeljujem rezultat izvođenja funkcije slicajniBroj
...
for(let i=0; i<6; i++){
    log(slucajniBroj(1,45)) // zovem funkciju slucajniBroj s dva parametra
}
...
// u rekurziji moramo paziti na stacjoverflow
...
// arrow funkcijama ne možemo pristupiti prije inicijaliziranja
//hello() //skripta.js:169 Uncaught ReferenceError: Cannot access 'hello' before initialization
...
// potrebno ; prjie, to je IIFE - detaljnije čitati
;(()=>{

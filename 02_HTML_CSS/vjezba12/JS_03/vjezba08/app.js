   ...
   document.getElementById('zad01').addEventListener('click', function() {
...
console.log(`Prvi: ${niz[0]}, Zadnji: ${niz[niz.length - 1]}`);
      ...
      ================================================= */
       ...
       document.getElementById('zad02').addEventListener('click', function() {
      ...
      /* =================================================
         ...
         - ispiši niz
      ================================================= */
      document.getElementById('zad03').addEventListener('click', function() {
        const a = document.getElementById('inA').value;
        const b = document.getElementById('inB').value;
        const niz = [a,b,3];
        console.log("Prije zamjene:", niz);
        [niz[0], niz[1]] = [niz[1], niz[0]];
        console.log("Nakon zamjene:", niz);
      })
      ...
      ================================================= */
      document.getElementById('zad04').addEventListener('click', function() {
        const A = document.getElementById('inA').value;
        const B = document.getElementById('inB').value;
        const niz = [A, B];
